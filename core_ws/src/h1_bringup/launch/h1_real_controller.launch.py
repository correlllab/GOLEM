...
# Absolute path to the checkout on the robot's onboard PC. This URDF is read at
# launch-description build time, so a wrong path aborts the entire controller
# launch -- estop, state publishers, safety layer and frame_task all fail to
# start. GOLEM_ASSETS_DIR overrides it without a code edit.
