...
case "$TEST_CASE" in
    ...
    locomotion) exec python3 /home/code/tests/stack/check_lowerbody.py --telemetry /telemetry/state.jsonl --output /results/report.json --wall-timeout "$GOLEM_TEST_WALL_TIMEOUT" ;;
    *) exit 2 ;;
esac
